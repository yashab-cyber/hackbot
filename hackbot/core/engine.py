...
PROVIDERS = {
    ...
    "anthropic": {
        ...
        "models": [
            ...
            {"id": "claude-opus-4-20250514", "name": "Claude Opus 4 (strongest)", "ctx": 200000},
    ...
    "gemini": {
        ...
        "models": [
            ...
            {"id": "gemini-2.5-flash", "name": "Gemini 2.5 Flash (fast)", "ctx": 1000000},
            {"id": "gemini-2.0-flash", "name": "Gemini 2.0 Flash", "ctx": 1000000},
            {"id": "gemini-1.5-pro", "name": "Gemini 1.5 Pro", "ctx": 2000000},
    ...
    "groq": {
        ...
        "models": [
            ...
            {"id": "llama3-70b-8192", "name": "LLaMA 3 70B", "ctx": 8192},
    ...
    "mistral": {
        ...
        "models": [
            ...
            {"id": "mistral-medium-latest", "name": "Mistral Medium", "ctx": 32000},
    ...
    "openrouter": {
        ...
        "models": [
            {"id": "anthropic/claude-sonnet-4-20250514", "name": "Claude Sonnet 4", "ctx": 200000},
            {"id": "anthropic/claude-opus-4-20250514", "name": "Claude Opus 4", "ctx": 200000},
            {"id": "openai/gpt-4o", "name": "GPT-4o", "ctx": 128000},
            {"id": "google/gemini-2.5-pro", "name": "Gemini 2.5 Pro", "ctx": 1000000},
            {"id": "meta-llama/llama-3.3-70b-instruct", "name": "LLaMA 3.3 70B", "ctx": 128000},
            {"id": "deepseek/deepseek-r1", "name": "DeepSeek R1", "ctx": 64000},
            {"id": "mistralai/mistral-large-2411", "name": "Mistral Large", "ctx": 128000},
        ],
    },
    "ollama": {
        "name": "Ollama (Local)",
        ...
        "models": [
            ...
            {"id": "phi3:medium", "name": "Phi-3 Medium", "ctx": 128000},
        ],
    },
    "local": {
